...
variables_real_mxn <- nearshoring %>%
  rename(
...
This report discusses the role of predictive analytics in optimizing supply chains and nearshoring strategies.    
  
**McKinsey & Company. (2022).** Nearshoring: A Solution for U.S. Supply Chain Vulnerabilities. McKinsey Insights.  
McKinsey analyzes how predictive analytics and nearshoring are transforming U.S. supply chains.  
  
**The Economist. (2022).** The Rise of Nearshoring in Mexico.  
This article explores how Mexico is emerging as a key player in nearshoring due to its proximity to the U.S. and trade dynamics.
    
**Moss, T. (2020).** Measuring the Impact of Nearshoring on Mexico’s Economy. Economía Mexicana, 29(2), 15-31.  
This study identifies metrics like foreign direct investment (FDI) and sectoral changes to evaluate nearshoring's effects in Mexico.  
    
**Wooldridge, J. M. (2010).** Econometric Analysis of Cross Section and Panel Data. MIT Press.  
This textbook provides in-depth knowledge of panel data regression techniques, including longitudinal analysis.  
